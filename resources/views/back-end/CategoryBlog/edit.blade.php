...
<div class="card-header">
    <h3 class="card-title">Sửa danh mục blog</h3>
</div>
<form id="edit-product-form" action="{{ asset('') . 'admin/category-blog/update/'.$cate->id}}" method="post" enctype="multipart/form-data" style="padding:20px">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-12 d-flex justify-content-end">
                    ...
                    <a href="{{ asset('') .'admin/category-blog/index' }}" class="btn btn-sm btn-danger">Hủy</a>
                </div>
            </div>
        </form>
        </div>
    ...
    $(document).ready(function() {
            $('#edit-product-form').validate({
                rules:{
                    ...
                    minlength: 2,
                    remote: {
                            url: "{{ asset('') . 'admin/category-blog/check-name'}}",
                            type: "post",
                            data: {
                                "_token": "{{ csrf_token() }}", 
                                name: function() {
