...
<div class="card-header">
    <h3 class="card-title">Thêm danh mục blog </h3>
</div>
<form id="add-product-form" action="{{ asset('') . 'admin/category-blog/save-add'}}" method="post" enctype="multipart/form-data" style="padding:20px">
            @csrf
            <div class="row">
                <div class="col-6">
