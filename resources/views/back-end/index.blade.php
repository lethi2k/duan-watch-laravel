...
<div class="col-md-12 my-5">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white" style="background: url('quan-tri/admin/dist/img/slider1.jpg') center center;">
