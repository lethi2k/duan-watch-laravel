...
<form id="add-product-form" action="{{ asset('') . 'admin/advertisement/save-add'}}" method="post" enctype="multipart/form-data" style="padding:20px">
            @csrf
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="price" class="form-control " placeholder="Nhập tên sản phẩm">
                    </div>   
                    <div class="form-group">
