    ...
    <table class="table table-stripped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$print->name}}</td>
                <td>{{$print->title}}</td>
                <td><img src="{{asset('') .'giao-dien/images/advertisement/'.$print->images}}" alt=""></td>
                <td>{{$print->content}}</td>
                <td>{{$print->price}}</td>
                ...
                <td>
                    <a href="{{asset('').'admin/advertisement/edit/'.$print->id}}" class="btn btn-sm btn-primary"><i
                            class="fas fa-wrench"></i></a> &nbsp;
                    <a href="{{asset('').'admin/advertisement/delete/'.$print->id}}"
