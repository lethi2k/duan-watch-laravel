...
<table class="table table-stripped">
    ...
    @foreach($Cate as $print)
            ...
            <td>{{$print->price}}</td>
               <td>
                <a href="{{asset('').'admin/advertisement/edit/'.$print->id}}" class="btn btn-sm btn-primary"><i class="fas fa-wrench"></i></a> &nbsp;
                <a href="{{asset('').'admin/advertisement/delete/'.$print->id}}" class="btn btn-sm btn-danger btn-remove"><i class="fas fa-trash"></i></a>
                </td>
            </tr>
      @endforeach
        </tbody>
    ...
    <script>
     ...
     <script type="text/javascript">
            $('#search').on('keyup',function(){
                ...
                $.ajax({
                    type: 'get',
                    url: '{{ URL::to('admin/advertisement/search') }}',
                    data: {
                        'search': $value
                    },
