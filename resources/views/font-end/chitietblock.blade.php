                                        ...
                                        <div class="social__sharing mb--30">
                                            ...
                                            <ul class="social social-round">
                                                <li class="social__item">
                                                    <a href="facebook.com" class="social__link"><i class="fa fa-facebook"></i></a>
                                                </li>
                                                <li class="social__item">
                                    ...
                                    <div class="related-posts-wrap">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 mb-md--30">
                                                <div class="related-post">
                                                    <a href="blog-details-image.html" class="related-post__thumb">
                                                        <img src="./giao-dien/images/blog1.jpg" alt="portfolio">
                                                    </a>
                                            ...
                                            <div class="col-lg-4 mb-md--30">
                                                <div class="related-post">
                                                    <a href="single-portfolio.html" class="related-post__thumb">
                                                        <img src="./giao-dien/images/blog2-1024x613.jpg" alt="portfolio">
                                                    </a>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="related-post">
                                                    <a href="blog-details-image.html" class="related-post__thumb">
                                                        <img src="./giao-dien/images/blog3.jpg" alt="portfolio">
                                                    </a>
                                    ...
                                    <div class="comment-respond">
                                        ...
                                        <ul class="comment-list">
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-avatar">
                                                        <img src="./giao-dien/images/comment-1.jpg" alt="comment">
                                                    </div>
                                                ...
                                                <ul class="children">
                                                    <li>
                                                        <div class="single-comment">
                                                            <div class="comment-avatar">
                                                                <img src="./giao-dien/images/comment-2.jpg" alt="comment">
                                                            </div>
                                                            <div class="comment-info">
                                                                <div class="comment-meta">
                                            ...
                                            <li>
                                                <div class="single-comment">
                                                    <div class="comment-avatar">
                                                        <img src="./giao-dien/images/comment-3.jpg" alt="comment">
                                                    </div>
                                                    <div class="comment-info">
                                                        <div class="comment-meta">
                                                            <h5 class="comment-author"><a href="#">Julia Rebeca</a></h5>
