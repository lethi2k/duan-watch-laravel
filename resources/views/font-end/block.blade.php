                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb justify-content-center">
                            ...
                            <li class="current"><a href="blog.html">Blog Left Sidebar</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="post-media">
                                            <div class="image">
                                            	<a href="blog-details-image.html">
	                                                <img src="./giao-dien/images/blog1.jpg" alt="blog">
	                                            </a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                    ...
                                    <article class="post single-post format-gallery">
                                        <div class="post-media">
                                            <div class="post-gallery nav-vertical-center slick-initialized slick-slider"><span class="slick-btn slick-prev slick-arrow" style=""><i class="fa fa-angle-left"></i></span>
                                                <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 2870px; transform: translate3d(-410px, 0px, 0px);"><div class="single-post-gallery slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style="width: 390px;" tabindex="-1">
                                                    <img src="./giao-dien/images/blog5.jpg" alt="blog">
                                                </div><div class="single-post-gallery slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style="width: 390px;" tabindex="0">
                                                    <img src="./giao-dien/images/blog2-1024x613.jpg" alt="blog">
                                                </div><div class="single-post-gallery slick-slide" data-slick-index="1" aria-hidden="true" style="width: 390px;" tabindex="-1">
                                                    <img src="./giao-dien/images/blog3.jpg" alt="blog">
                                                </div><div class="single-post-gallery slick-slide" data-slick-index="2" aria-hidden="true" style="width: 390px;" tabindex="-1">
                                                    <img src="./giao-dien/images/blog5.jpg" alt="blog">
                                                </div><div class="single-post-gallery slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" style="width: 390px;" tabindex="-1">
                                                    <img src="./giao-dien/images/blog2-1024x613.jpg" alt="blog">
                                                </div><div class="single-post-gallery slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" style="width: 390px;" tabindex="-1">
                                                    <img src="./giao-dien/images/blog3.jpg" alt="blog">
                                                </div><div class="single-post-gallery slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" style="width: 390px;" tabindex="-1">
                                                    <img src="./giao-dien/images/blog5.jpg" alt="blog">
                                                </div></div></div>
                                        ...
                                        <div class="post-info">
                                            <header class="entry-header">
                                                ...
                                                <h2 class="post-title"><a href="blog-details-gallery.html">Blog Gallery Post</a></h2>
                                            </header>
                                            <div class="post-content">
                                                <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis</p>
                                            </div>
                                ...
                                <div class="col-lg-6 mb--30">
                                    <article class="post single-post format-standard">
                                        <div class="post-media">
                                            <div class="image">
                                            	<a href="blog-details-image.html">
                                            		<img src="./giao-dien/images/blog4-1024x613.jpg" alt="blog">
                                            	</a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                ...
                                <div class="col-lg-6 mb--30">
                                    <article class="post single-post format-standard">
                                        <div class="post-media">
                                            <div class="image">
                                            	<a href="blog-details-image.html">
                                            		<img src="./giao-dien/images/post1-370x230.jpg" alt="blog">
                                            	</a>
                                            </div>
                                        </div>
                                        <div class="post-info">
                                    ...
                                    <div class="widget_conent">
                                        <div class="recent-post-single">
                                            <div class="recent-post-media">
                                                <div class="image">
                                                    <img src="./giao-dien/images/post4-370x230.jpg" alt="Blog">
                                                </div>
                                            </div>
                                        ...
                                        <div class="recent-post-single">
                                            <div class="recent-post-media">
                                                <div class="image">
                                                    <img src="./giao-dien/images/post3-370x230.jpg" alt="Blog">
                                                </div>
                                            </div>
                                            <div class="recent-post-content">
                                                <h4><a href="single-blog.html">Gravida luctus lorem accumsan est massa mauris.</a></h4>
                                        ...
                                        <div class="recent-post-single">
                                            <div class="recent-post-media">
                                                <div class="image">
                                                    <img src="./giao-dien/images/post2-370x230.jpg" alt="Blog">
                                                </div>
                                            </div>
                                            <div class="recent-post-content">
                                                <h4><a href="single-blog.html">Gravida luctus lorem accumsan est massa mauris.</a></h4>
                                    ...
                                    <ul class="twitter-feed">
                                        <li>
                                            <div class="twitter-feed__avatar">
                                                <img src="./giao-dien/images/comment-icon.png" alt="avatar">
                                            </div>
