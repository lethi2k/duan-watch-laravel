                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <ul class="breadcrumb justify-content-center">
                            ...
                            <li class="current"><a href="shop.html">About</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row no-gutters">
                        <div class="col-lg-3 col-sm-6">
                            <div class="fact">
                                <div class="fact__icon">
                                    <img src="./giao-dien/images/about-us-icon1.png" alt="about icon">
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="fact">
                                <div class="fact__icon">
                                    <img src="./giao-dien/images/about-us-icon2.png" alt="about icon">
                                </div>
                                <div class="fact__content">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="fact">
                                <div class="fact__icon">
                                    <img src="./giao-dien/images/about-us-icon3.png" alt="about icon">
                                </div>
                                <div class="fact__content">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="fact">
                                <div class="fact__icon">
                                    <img src="./giao-dien/images/about-us-icon4.png" alt="about icon">
                                </div>
                                <div class="fact__content">
