            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h1 class="page-title">Tài Khoản Khách hàng</h1>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="index.html">Trang Chủ</a></li>
                            <li class="current"><a href="my-account.html">Tài Khoản Khách hàng</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-md--30">
                                <div class="user-dashboard-tab__head nav flex-column" role="tablist" aria-orientation="vertical">
                                    <a class="nav-link active" data-toggle="pill" role="tab" href="#dashboard" aria-controls="dashboard" aria-selected="true">Tổng Quan</a>
                                    <a class="nav-link" data-toggle="pill" role="tab" href="#orders" aria-controls="orders" aria-selected="true">Lịch sử đặt hàng</a>
                                    <a class="nav-link" data-toggle="pill" role="tab" href="#downloads" aria-controls="downloads" aria-selected="true">Downloads</a>
                                    <a class="nav-link" data-toggle="pill" role="tab" href="#addresses" aria-controls="addresses" aria-selected="true">Địa Chỉ</a>
                                    <a class="nav-link" data-toggle="pill" role="tab" href="#accountdetails" aria-controls="accountdetails" aria-selected="true">Đổi Mật Khẩu</a>
                                    <a class="nav-link" href="login-register.html">Đăng Nhập</a>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                                ...
                                                <form action="#" class="form">
                                                    ...
                                                    <div class="form-row mb--20">
                                                        <div class="form__group col-12">
                                                            ...
                                                            </select><div class="nice-select form__input form__input--2" tabindex="0"><span class="current">Select a District…</span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Search..."></div><ul class="list"><li data-value="" class="option selected">Select a District…</li><li data-value="BARISAL" class="option">BARISAL</li><li data-value="BHOLA" class="option">BHOLA</li><li data-value="BANDARBAN" class="option">BANDARBAN</li><li data-value="BRAHMANBARIA" class="option">BRAHMANBARIA</li><li data-value="CHANDPUR" class="option">CHANDPUR</li><li data-value="CHITTAGONG" class="option">CHITTAGONG</li><li data-value="COMILLA" class="option">COMILLA</li><li data-value="COX'S BAZAR" class="option">COX'S BAZAR</li><li data-value="DHAKA" class="option">DHAKA</li><li data-value="FARIDPUR" class="option">FARIDPUR</li><li data-value="FENI" class="option">FENI</li><li data-value="GAZIPUR" class="option">GAZIPUR</li><li data-value="GOPALGANJ" class="option">GOPALGANJ</li><li data-value="JAMALPUR" class="option">JAMALPUR</li><li data-value="KHAGRACHHARI" class="option">KHAGRACHHARI</li><li data-value="KISHOREGONJ" class="option">KISHOREGONJ</li><li data-value="LAKSHMIPU" class="option">LAKSHMIPU</li><li data-value="RMADARIPUR" class="option">RMADARIPUR</li><li data-value="MUNSHIGANJ" class="option">MUNSHIGANJ</li><li data-value="MYMENSINGH" class="option">MYMENSINGH</li><li data-value="NARAYANGANJ" class="option">NARAYANGANJ</li><li data-value="NARSINGDI" class="option">NARSINGDI</li><li data-value="NETRAKONA" class="option">NETRAKONA</li><li data-value="NOAKHALI" class="option">NOAKHALI</li><li data-value="RANGAMATI" class="option">RANGAMATI </li><li data-value="RAJBARI" class="option">RAJBARI</li><li data-value="SHARIATPUR" class="option">SHARIATPUR</li><li data-value="SHERPUR" class="option">SHERPUR</li><li data-value="TANGAIL" class="option">TANGAIL</li></ul></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-row mb--20">
                                                        <div class="form__group col-12">
